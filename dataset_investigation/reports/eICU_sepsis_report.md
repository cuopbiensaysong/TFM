...
- `mimic_liver` present: HADM_ID, map_normalized
- `mimic_liver` missing: bloodprod, hr_normalized_scaled, prbc_outcome, pressor, severe_liver, time_scaled_v1
